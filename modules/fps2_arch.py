...
class FPForget(fp.FPSolver):
    ...
    Args:
        ...
        ------ parent args ------
        eqn, taylor: a tensorflow layer object representing the space differential operator L
    ...
    """
    def __init__(self, num_nodes, num_layers, eqn, taylor, ens_file, domain, init_cond, dtype=tf.float64,\
                 name = 'FPForget', save_path=None):
        super().__init__(eqn, taylor, ens_file, domain, init_cond, dtype, name, save_path)
