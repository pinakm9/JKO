...
class FPForget(fp.FPSolver):
    ...
    """
    def __init__(self, num_nodes, num_layers, diff_op, ens_file, domain, init_cond, dtype=tf.float64,\
                 name = 'FPForget', save_path=None):
        super().__init__(diff_op, ens_file, domain, init_cond, dtype, name, save_path)
