...
class JKOMAF(jko.JKOSolver):

    def __init__(self, output_dim, num_masked, num_bijectors, psi, beta, ens_file, cost_file, sinkhorn_epsilon=0.01, sinkhorn_iters=100, name = 'JKOMAF'): #** additional arguments for the super class
        dtype = tf.float32
