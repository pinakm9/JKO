...
class FPLSTM(fp.FPSolver):
    """
    Description: 
        LSTM architecture for the FPSolver, inherits from FPSolver
    Args:
    ...
    """
    def __init__(self, num_nodes, num_layers, diff_op, ens_file, cost_file, sinkhorn_epsilon=0.01, sinkhorn_iters=100, name = 'FPLSTM'):
        self.num_nodes = num_nodes
        self.num_layers = num_layers
        dtype = tf.float32
        super().__init__(diff_op, ens_file, cost_file, sinkhorn_epsilon, sinkhorn_iters, dtype, name)
