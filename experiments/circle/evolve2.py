...
steps = 1000
eqn = sde.SDE(2, mu, sigma, 'data/evolution2_{}_helper.h5'.format(steps), dtype=np_dtype)
...
sde.SDEPlotter('data/evolution2_{}_helper.h5'.format(steps))#, ax_lims=[(-1.5, 1.5), (-1.5, 1.5)])