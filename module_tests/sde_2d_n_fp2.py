...
solver = fp.FPVanilla(20, 3, DiffOp, ens_file, domain, InitialPDF().call, sinkhorn_iters=20, sinkhorn_epsilon=0.01,\
                      name='FPVanilla_2_n', dtype=dtype)
solver.summary()


solver.solve(100, 0, 5000)
